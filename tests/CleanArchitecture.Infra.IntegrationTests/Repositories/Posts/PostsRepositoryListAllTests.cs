...
namespace CleanArchitecture.Infra.IntegrationTests.Repositories.Posts
{
    ...
    public class PostsRepositoryListAllTests
    {
        ...
        public PostsRepositoryListAllTests(DatabaseFixture fixture)
        {
            _fixture = fixture;
        ...
        [Fact(DisplayName = "PostRepository_ListAllAsync_Success")]
        public async Task PostRepository_ListAllAsync_Success()
        {
            //Arrange
            ...
            //Act
           var blogs = await _postRepository.ListAllAsync();
